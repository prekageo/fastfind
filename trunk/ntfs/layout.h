...
} __attribute__((__packed__)) _MFT_RECORD_FLAGS;
typedef unsigned short MFT_RECORD_FLAGS;
...
} __attribute__((__packed__)) _ATTR_FLAGS;
typedef unsigned short ATTR_FLAGS;
...
} __attribute__((__packed__)) _RESIDENT_ATTR_FLAGS;
typedef unsigned char RESIDENT_ATTR_FLAGS;
...
typedef enum {
	...
	FILE_NAME_WIN32_AND_DOS		= 0x03,
		/* 3 means that both the Win32 and the DOS filenames are
		   ...
		   record. */
} __attribute__((__packed__)) _FILE_NAME_TYPE_FLAGS;
typedef unsigned char FILE_NAME_TYPE_FLAGS;
...
} __attribute__((__packed__)) _ACE_FLAGS;
typedef unsigned char ACE_FLAGS;
...
} __attribute__((__packed__)) _SECURITY_DESCRIPTOR_CONTROL;
...
} __attribute__((__packed__)) _VOLUME_FLAGS;
typedef unsigned short VOLUME_FLAGS;
...
} __attribute__((__packed__)) _INDEX_HEADER_FLAGS;
typedef unsigned char INDEX_HEADER_FLAGS;
...
} __attribute__((__packed__)) _INDEX_ENTRY_FLAGS;
typedef unsigned short INDEX_ENTRY_FLAGS;
...
typedef enum {
	NEED_EA	= 0x80,		/* Indicate that the file to which the EA
				   ...
				   attributes. */
} __attribute__((__packed__)) _EA_FLAGS;
typedef unsigned char EA_FLAGS; 
