 ...
 */
//#define ntfs_log_critical(FORMAT) ntfs_log_redirect(__FUNCTION__,__FILE__,__LINE__,NTFS_LOG_LEVEL_CRITICAL,NULL,FORMAT)
//#define ntfs_log_error(FORMAT) ntfs_log_redirect(__FUNCTION__,__FILE__,__LINE__,NTFS_LOG_LEVEL_ERROR,NULL,FORMAT)
//#define ntfs_log_info(FORMAT, ARGS...) ntfs_log_redirect(__FUNCTION__,__FILE__,__LINE__,NTFS_LOG_LEVEL_INFO,NULL,FORMAT,##ARGS)
//#define ntfs_log_perror(FORMAT) ntfs_log_redirect(__FUNCTION__,__FILE__,__LINE__,NTFS_LOG_LEVEL_PERROR,NULL,FORMAT)
...
//#define ntfs_log_warning(FORMAT) ntfs_log_redirect(__FUNCTION__,__FILE__,__LINE__,NTFS_LOG_LEVEL_WARNING,NULL,FORMAT)

#define ntfs_log_critical __noop
#define ntfs_log_error __noop
#define ntfs_log_perror __noop
#define ntfs_log_warning __noop
...
#define ntfs_log_debug __noop
#define ntfs_log_trace __noop
#else /* !DEBUG */
